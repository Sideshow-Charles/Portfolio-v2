...
const Footer: React.FC = () => {
  ...
  return (
    <div className="bg-black text-stone-300 px-24 py-24 max-md:px-12 max-sm:px-6">
      <div className="max-w-7xl mx-auto flex justify-between flex-col">
        <p className="leading-relaxed mb-16 max-md:text-lg leading-loose max-sm:text-base">
