...
const About = () => {
    return (
        <div>
            ...
            <section className="flex flex-col my-24 mx-24 px-16 max-md:mx-12 px-0 max-sm:mx-6 px-0">
            ...
            <section className="flex flex-col my-52 mx-24 px-16 max-md:mx-12 px-0 max-sm:mx-6 px-0">
