    ...
    return (
        <div>
            ...
            <section className=" mt-36 mx-24 text-center max-md:mx-12 max-sm:mx-6">
                ...
                <p className="mt-8 text-xl text-gray-500 max-md:text-lg max-sm:text-base">Take a look at a few projects I've worked on, to see how I bring concepts to life, prioritize user experience.</p>
            </section>
            {/* End of Hero Section */}
