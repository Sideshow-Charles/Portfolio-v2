    ...
    return (
        <div>
            ...
            <ProjectDescription
                ...
                Worked on this using Nuxt.js (a vue.js framework), vanilla CSS for styling and javascript for logic. The events being displayed
                ...
                projectTechnology="Nuxt.js, Javascript, CSS">
            </ProjectDescription>
            ...
            <ProjectDescription
                ...
                I Worked on this using Nuxt.js (a vue.js framework), vanilla CSS for styling and javascript for logic. The events being displayed
                are gotten from a dummy API and they're pretty much dummy events."
